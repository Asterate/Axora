...
public static class DocumentTypeMapper
{
    ...
    public static DocumentType ToEntity(SaveDocumentTypeRequest request)
        => new ()
        {
           Name = new LangStr()
           {
    ...
    public static void UpdateEntity(DocumentType entity, SaveDocumentTypeRequest request)
    {
    ...
    public static SaveDocumentTypeRequest ToUpdateRequest(DocumentType entity)
    {
        return new SaveDocumentTypeRequest
        {
